...
| 機能 | LangGraph Platform | azure-functions-langgraph-python |
|------|-------------------|--------------------------|
...
- **新しいオプショナルextras**: `pip install azure-functions-langgraph-python[azure-blob,azure-table]`で永続ストレージ
...
**設計原則:** `azure-functions-langgraph-python`はLangGraphランタイム公開を担当。`azure-functions-validation-python`はバリデーションを担当。`azure-functions-openapi-python`はAPIドキュメントを担当。

| パッケージ | 役割 |
|-----------|------|
| **azure-functions-langgraph-python** | Azure Functions用LangGraphデプロイアダプター |
